...
class DateWindow:
    def __init__(self, start_date: date | datetime = datetime.today(), interval: str = "month", count: int = 1) -> None:
    ...
    def set_start_date(self, new_start: date | datetime) -> None:
        """rounds the specified start date down to the first day of the calendar interval"""
        self._validate_interval()
        self.start_date = to_date(self._round_to_interval_start(to_date(new_start)))
        self._update_end_date()

    def set_interval(self, interval: str, count: int = 1) -> None:
    ...
    def shift_forward(self, n: int = 1) -> None:
        if self.interval == "day":
    ...
    def shift_backward(self, n: int = 1) -> None:
